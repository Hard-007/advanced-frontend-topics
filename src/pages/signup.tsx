    ...
    return (
        <div className="min-h-screen bg-gray-100 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-md w-full space-y-8 bg-white p-10 rounded-xl shadow-md">
                <div>
                    <h2 className="mt-6 text-center text-3xl font-extrabold text-gray-900">Crie uma conta</h2>
                </div>
                ...
                <form className="mt-8 space-y-6" onSubmit={handleEmailPasswordSignup}>
                    <div className="rounded-md shadow-sm -space-y-px">
                        ...
                        <div>
                            <label htmlFor="confirm-password" className="sr-only">Confirmar Password</label>
                            <input
                                id="confirm-password"
